...
<!-- 商品推荐 -->
<div id="animate_recommendfangyuanxinxi" class="recommend animate__animated" :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff","order":"2"}'>
    ...
    <div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
		<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>房源信息推荐</span>
	</div>
	...
	<div v-if="fangyuanxinxiRecommend.length" class="list list12 index-pv1 list12fangyuanxinxi" :style='{"width":"100%","padding":"10px","background":"#fff","display":"flex","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto","order":"1"}'>
	    <div :style='{"border":"1px solid #D8D8D8","width":"calc(100% / 3 - 20px)","margin":"0 0 20px","position":"relative","borderWidth":"0 0 2px","height":"auto"}' class="item list-item animation-box" v-for="item,index in fangyuanxinxiRecommend" :key="index" @click="toDetail('fangyuanxinxiDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.fangwutupian)" :src="item.fangwutupian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.fangwutupian?item.fangwutupian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.fangwumingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>出租状态:{{item.chuzuzhuangtai}}</div>
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>房源价格:{{item.fangyuanjiage}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('fangyuanxinxi')" :style='{"border":"1px solid #9E9E9E","margin":"0 0 0 -40px","top":"22px","textAlign":"center","left":"33%","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute"}'>
  ...
  export default {
    ...
    data() {
      return {
		...
		recommendIndex12fangyuanxinxi: 0,
		recommendList12fangyuanxinxi: [],
		recommendColumn12fangyuanxinxi: '',
    ...
    created() {
		...
		this.getList();
		this.fangyuanxinxiRecommendCate()
    },
	mounted() {
    ...
    methods: {
		...
		fangyuanxinxiRecommendCate(){
			this.$http.get('leibie/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12fangyuanxinxi = res.data.data.list
			  }
			});
			this.recommendColumn12fangyuanxinxi = 'leibie'
		},
      ...
      getSystemIntroduction() {
		...
		getList() {
          ...
          if(localStorage.getItem('frontToken')) {
			...
			if(this.recommendIndex12fangyuanxinxi != 0){
				data.leibie = this.recommendList12fangyuanxinxi[this.recommendIndex12fangyuanxinxi - 1].leibie
			}
