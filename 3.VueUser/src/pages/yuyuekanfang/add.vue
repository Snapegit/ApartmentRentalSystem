...
<div :style='{"width":"80%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="预约备注" prop="yuyuebeizhu">
            <el-input v-model="ruleForm.yuyuebeizhu" 
                placeholder="预约备注" clearable :disabled=" false  ||ro.yuyuebeizhu"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="预约日期" prop="yuyueriqi">
              <el-date-picker
