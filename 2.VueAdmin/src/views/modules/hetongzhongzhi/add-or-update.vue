		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="登记编号" prop="dengjibianhao">
					<el-input v-model="ruleForm.dengjibianhao" placeholder="登记编号" clearable  :readonly="ro.dengjibianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="登记编号" prop="dengjibianhao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="签订日期" prop="qiandingriqi">
					<el-input v-model="ruleForm.qiandingriqi" placeholder="签订日期" clearable  :readonly="ro.qiandingriqi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="签订日期" prop="qiandingriqi">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="终止时间" prop="zhongzhishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.zhongzhishijian" label="终止时间" prop="zhongzhishijian">
					<el-input v-model="ruleForm.zhongzhishijian" placeholder="终止时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="终止原因" prop="zhongzhiyuanyin">
					<el-input v-model="ruleForm.zhongzhiyuanyin" placeholder="终止原因" clearable  :readonly="ro.zhongzhiyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="终止原因" prop="zhongzhiyuanyin">
					<el-input v-model="ruleForm.zhongzhiyuanyin" placeholder="终止原因" readonly></el-input>
				</el-form-item>
			</template>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `hetongzhongzhi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.hetongzhongzhiCrossAddOrUpdateFlag = false;
											this.parent.search();
