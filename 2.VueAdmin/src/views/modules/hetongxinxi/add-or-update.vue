<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="登记编号" prop="dengjibianhao">
					<el-input v-model="ruleForm.dengjibianhao" placeholder="登记编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.dengjibianhao" label="登记编号" prop="dengjibianhao">
					<el-input v-model="ruleForm.dengjibianhao" placeholder="登记编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="签订备注" prop="qiandingbeizhu">
					<el-input v-model="ruleForm.qiandingbeizhu" placeholder="签订备注" clearable  :readonly="ro.qiandingbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="签订备注" prop="qiandingbeizhu">
					<el-input v-model="ruleForm.qiandingbeizhu" placeholder="签订备注" readonly></el-input>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.hetongzhuangtai = '生效中'; 			}
			// 获取用户信息
			this.$http({
